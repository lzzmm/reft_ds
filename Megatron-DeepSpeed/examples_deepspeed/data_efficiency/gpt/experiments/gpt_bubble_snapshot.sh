./ds_pretrain_gpt.sh model_size_config=5 checkpoint_new_thread="true" checkpoint_new_stream="true" \
                     enable_parity="false" enable_pin_memory="true" enable_sharding="true" \
                     enable_profile="false" enable_save="false" save_location="tmpfs" enable_snapshot="true" \
