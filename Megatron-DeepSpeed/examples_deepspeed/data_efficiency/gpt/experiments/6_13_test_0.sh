srun --pty --partition=i64m1tga800u --job-name=slurm_test --nodes=8 \
...
--nodelist=gpu3-11 -- bash -c '
  ...
  bash ./ds_pretrain_gpt.sh model_size_config=9 checkpoint_new_thread="true" checkpoint_new_stream="true" \
