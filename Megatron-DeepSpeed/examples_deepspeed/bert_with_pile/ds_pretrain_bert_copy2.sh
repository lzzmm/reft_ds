...
batch_size=8 #16 # $(( ${global_batch_size} / ${dp_size} ))
###############################################################################
### Misc configs
log_interval=100
eval_iters=10
...
username=$(whoami)
output_home="/home/comp/19481691/yxwang/ckpt"
...
CUDA_VISIBLE_DEVICES=4,5,6,7 deepspeed ${dir}/../../pretrain_bert.py ${megatron_options} ${data_options} ${deepspeed_options} &>> ${log_path}/${jobname}_${host}_${current_time}.log