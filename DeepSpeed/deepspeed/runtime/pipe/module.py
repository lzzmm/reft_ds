...
class PipelineModule(nn.Module):
    ...
    def save_state_dict(self, save_dir, checkpoint_engine, exclude_frozen_params=False, shard_info_dict={}):
        ...
        for idx, layer in enumerate(layer_list):
            ...
            checkpoint_engine.save(final_state_dict, model_ckpt_path, shard_info_dict=shard_info_dict)
