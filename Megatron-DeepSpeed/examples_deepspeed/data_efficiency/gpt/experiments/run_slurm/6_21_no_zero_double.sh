...
--nodelist=gpu3-11 -- bash -c '
  ...
  bash ../ds_pretrain_gpt_slurm_no_zero.sh model_size_config=8 checkpoint_new_thread="true" checkpoint_new_stream="true" \
                     enable_parity="false" enable_pin_memory="true" enable_sharding="true" \
                     enable_profile="false" enable_save="false" save_location="nfs" enable_snapshot="true" \
                     ...
                     original_load="false" double_snapshot="true" failed_ranks="" enable_non_blocking="true"
'