...
def compile_helper():
    ...
    # Get the path to the currently used Python interpreter
    python_executable = sys.executable
    
    # Get the directory of the currently used Python interpreter
    python_dir = os.path.dirname(python_executable)
    
    # Set the PATH environment variable so that the Conda environment's bin directory
    # is included at the start. This ensures the environment's Python and other
